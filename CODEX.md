...
> 本文件是 OpenAI Codex CLI 的项目入口。进入本仓库后请先阅读此文件。
...
- 本仓库使用 Node.js 24+，所有脚本在 `scripts/` 目录下
- 无外部 npm 依赖，所有工具自包含
- 项目注册表在 `projects/registry.yaml`
- 如需操作 VibeKanban MCP，参考 `docs/vibekanban-mcp-tools.md`
